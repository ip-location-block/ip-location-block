...
export const SECTIONS = [
	...
	},
	{
		...
		fields: [
			...
			{ path: 'exception.plugins', label: __( 'Plugins area exceptions', 'ip-location-block' ), type: 'checkbox-list', source: 'exceptions.plugins', shape: 'array' },
			{ path: 'exception.themes', label: __( 'Themes area exceptions', 'ip-location-block' ), type: 'checkbox-list', source: 'exceptions.themes', shape: 'array' },
		],
	},
	{
		key: 'public',
		...
		fields: [
			...
			{ path: 'public.target_pages', label: __( 'Target pages', 'ip-location-block' ), type: 'checkbox-list', source: 'content.pages', shape: 'map', showIf: ( s ) => Number( s.public?.target_rule ) === 1 },
			{ path: 'public.target_posts', label: __( 'Target post types', 'ip-location-block' ), type: 'checkbox-list', source: 'content.posts', shape: 'map', showIf: ( s ) => Number( s.public?.target_rule ) === 1 },
			{ path: 'public.target_cates', label: __( 'Target categories', 'ip-location-block' ), type: 'checkbox-list', source: 'content.cates', shape: 'map', showIf: ( s ) => Number( s.public?.target_rule ) === 1 },
			{ path: 'public.target_tags', label: __( 'Target tags', 'ip-location-block' ), type: 'checkbox-list', source: 'content.tags', shape: 'map', showIf: ( s ) => Number( s.public?.target_rule ) === 1 },
